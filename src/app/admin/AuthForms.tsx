...
const SubmitButton: React.FC<{ label: string }> = ({ label }) => {
	...
	return (
		<button
			type="submit"
			disabled={pending}
			className="inline-flex min-w-[140px] items-center justify-center rounded-full bg-gray-900 px-4 py-2 font-[family-name:var(--font-geist-sans)] text-sm font-medium text-gray-50 transition hover:bg-gray-700 disabled:cursor-not-allowed disabled:opacity-70 dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-gray-300"
		>
			{pending ? (
				<>
...
const RegisterForm = () => {
	...
	return (
		<div className="rounded-2xl border border-gray-200/60 bg-white/80 p-6 shadow-sm ring-1 ring-black/5 dark:border-gray-700/60 dark:bg-gray-900/70 dark:ring-white/5">
			<h1 className="mb-2 font-[family-name:var(--font-geist-sans)] text-2xl font-semibold text-gray-900 dark:text-gray-100">
				Create the first admin
			</h1>
			<p className="mb-6 font-[family-name:var(--font-geist-sans)] text-sm text-gray-600 dark:text-gray-400">
